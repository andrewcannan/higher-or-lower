...
| Timer            | On time run out                                                   | Turn to be over, incorrect score to increment, submit button to hide, next card red to show, hint text to show time ran out, and card to flip revealing answer            | As expected. |
...
| Input field      | On input of 3 incorrect values                                    | Amount of tries to decrease to 0, incorrect scores to increment by 1, submit button to hide, next card red to show, hint to display ran out of guesses, timer loop breaks | As expected. |
...
| Input field      | On input of correct value                                         | Correct score to increment by 1, card to flip revealing answer, submit button to hide, next card green to show, hint text to display congratulations, timer loop breaks   | As expected. |
